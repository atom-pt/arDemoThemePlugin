...
class arMoaThemePluginConfiguration extends sfPluginConfiguration
{
  ...
  public static
    $summary = 'Theme plugin, extension of arDominionPlugin. Cross-browser compatibility tested. Based in Twitter Bootstrap 2.0, 940px two-column layout, slightly responsive.',
    $version = '0.0.1';
